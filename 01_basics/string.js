...
console.log(gamename.indexOf('j')); // -1

const newString = gamename.substring(0, 3); // 0th index to 2th
console.log(newString); //  hit

const anstring = gamename.slice(-8, 4) 
//If negative, it is treated as startIndex = stringLength + startIndex(given).
// 9 + (-8) = 1 = startIndex (new)
//If negative, it is treated as endIndex = stringLength + endIndex(given).   
